...
>
	...
	>
		...
		<button
			...
			class="button-gleam min-w-[55px] rounded-md px-2 py-0 text-xs font-medium text-white transition focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1 disabled:opacity-60 dark:focus:ring-offset-slate-700 {copyButtonText === 'Copied!' ? 'bg-emerald-700' : 'bg-green-500 hover:bg-green-600'}"
		...
		{#if canShowPrevious}
			<button
				...
				class="min-w-[55px] rounded-md border px-2 py-0 text-xs font-medium transition focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1 active:bg-slate-500 dark:focus:ring-offset-slate-800 {canShowPrevious ? 'bg-slate-600 border-slate-500 text-gray-200 hover:bg-slate-500 hover:text-gray-100 active:text-gray-100' : 'opacity-50 cursor-not-allowed border-slate-700 text-gray-500'}"
